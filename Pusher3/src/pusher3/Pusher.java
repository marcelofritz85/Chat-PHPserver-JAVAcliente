...
//    private final String app_key = "b38bf1a720fdf5255cc0";
//    private final String canal = "likely-darkness-895";
//    private final String evento = "mensaje";
//    private final String host = "/chat/server.php";
    
    private final String app_key = "b38bf1a720fdf5255cc0";
    private final String canal = "likely-darkness-895";
    private final String evento = "mensaje";
    private final String host = "http://marcelofritz85.pe.hu/chat1/";
  ...
  {
    //------------------------------------------------------------------------  
      System.out.println("pusher3.Pusher.excutePost()");
    //------------------------------------------------------------------------
    URL url;
    ...
    try {
      ...
      //------------------------------------------------------------------------
        System.out.println(response);//ta recebendo linha branca
      //------------------------------------------------------------------------
